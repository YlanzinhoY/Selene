...
const (
	...
	textCompatdataReplaceLinkAction  = "Press m to safely replace the existing compatdata link."
	...
	textCompatdataRollbackResultHint = "The managed link was removed and the previous compatdata setup was restored. Selene kept the native compatdata target intact."
